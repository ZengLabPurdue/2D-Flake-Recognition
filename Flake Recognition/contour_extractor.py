...
if __name__ == "__main__":
    ...
    seed_point = pick_seed_point(image_bgr)

    contour_points, region_pixels, region_mask, contour = get_region_from_seed(
        image_bgr=image_bgr,
