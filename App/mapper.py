...
class App:
    ...
    def find_best_focus(self, z_start, z_end, steps, tolerance=0.1):
    ...
    def place_live_frame_on_map(self, img, zoom):
        ...
        x1 = min(self.true_map.shape[1], x_end)
        y1 = min(self.true_map.shape[0], y_end)
